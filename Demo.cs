...
namespace IapDemo
{
    ...
    public class AtDemo
    {
        public static String getAppAt()
        {
            ...
            String retString = httpPost(demoConfig.tokenUrl, "application/x-www-form-urlencoded; charset=UTF-8", msgBody, 5, null);
        ...
        public static String httpPost(String httpUrl, String contentType, String requestBody, int timeOut, HttpRequestHeaders headers)
        {
            ...
            client.DefaultRequestHeaders.Add(HttpRequestHeader.ContentType.ToString(), contentType);
            ...
            var httpContent = new ByteArrayContent(Encoding.UTF8.GetBytes(requestBody));
        ...
        public static HttpRequestHeaders buildAuthorization()
        {
            ...
            headers.Add(HttpRequestHeader.ContentType.ToString(), "application/json; charset=UTF-8");
            return headers;
        }
    ...
    public class Demo
    {
        ...
        static void Main(string[] args)
        {
            ...
            OrderDemo.verifyToken("demoToken", "demoProductId");

            OrderDemo.cancelledListPurchase(123, 456, 100, 0, "demoToken");

            SubscriptionDemo.getSubscription("demoId", "demoToken");

            SubscriptionDemo.stopSubscription("demoId", "demoToken");

            SubscriptionDemo.delaySubscription("demoId", "demoToken", 123, 456);

            SubscriptionDemo.returnFeeSubscription("demoId", "demoToken");

            SubscriptionDemo.withdrawalSubscription("demoId", "demoToken");
        }
    }
